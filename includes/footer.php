<footer class="u-align-center-sm u-align-center-xs u-clearfix u-custom-color-1 u-footer u-footer" id="sec-ac72">
    <a href="../../tatie_odette/index" class="u-image u-logo u-image-1" data-image-width="1600" data-image-height="1600">
        <img src="../../tatie_odette/images/TatieOdette.png" class="u-logo-image u-logo-image-1" data-image-width="102.6153" alt="logo">
    </a>
    <div class="u-list u-repeater u-list-1" style="margin: 15px auto 0 auto;">
    ...
    <div class="u-social-icons u-spacing-20 u-social-icons-1" style="margin-top: 0">
    ...
    <div class="u-custom-color-2 u-expanded-width u-shape u-shape-rectangle u-shape-1" style="height: 106px;">
        <div style="display: flex; justify-content: space-around; height: 100%;">
            <p class="u-text u-text-custom-color-1 u-text-21" style="margin: auto 0;">©2017-2021, TatieOdette.fr</p>
            <p class="u-text u-text-custom-color-1 u-text-21" style="margin: auto 0;">
                <span style="font-size: 1.125rem;">Politique de Confidentialité</span>
            </p>
            <p class="u-text u-text-custom-color-1 u-text-21" style="margin: auto 0;">
                <span style="font-size: 1.125rem;">Conditions générales de vente</span>
            </p>
        </div>
    </div>
</footer>